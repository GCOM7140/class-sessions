...
- To define a set of goals, objectives, requirements, and expectations for this
course.
- To set the foundation for an environment that respects differences and diverse
...
- [Sabermetrics][moneyball] is to baseball scouts as customer analytics is
to...?
